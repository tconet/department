...
import com.cesar.sharing.dto.costcenterresource.CostcenterResourceMessageDTO;
import com.cesar.sharing.entity.CostcenterResource;
import com.cesar.sharing.exceptions.BusinessException;
import com.cesar.sharing.service.CostcenterResourceService;
 ...
 *  for messages that is related to {@link CostcenterResource}
 * </>
 */
@Slf4j
@Component
public class CostCenterResourcePubSubConsumerController {
     ...
     *  about {@link CostcenterResource}. After receive and convert
