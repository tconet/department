...
import com.department.controller.CostCenterResourcePubSubConsumerController;
...
/**
 * <p>
 *  Create an inbound channel adapter specifically for {@link com.department.entity.CostcenterResource} messages.
...
@Slf4j
@Configuration
public class PubSubCostCenterResourceConsumerConfig {
     ...
     */
    @Bean
    public DirectChannel costCenterResourceInputChannel() {
     ...
     */
    @Bean
    public PubSubInboundChannelAdapter costCenterResourceChannelAdapter(
            @Qualifier("costCenterResourceInputChannel") MessageChannel inputChannel, PubSubTemplate pubSubTemplate) {
     ...
     * </>
     * @param consumer @see {@link com.department.controller.CostCenterResourcePubSubConsumerController}
     * @return @see {@link MessageHandler}
     */
    @Bean("costCenterResourceMessageReceiver")
    @ServiceActivator(inputChannel = "costCenterResourceInputChannel")
    public MessageHandler costCenterResourceMessageReceiver(CostCenterResourcePubSubConsumerController consumer) {
        return message -> {
